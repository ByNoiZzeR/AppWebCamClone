...
public class SettingsManager {
    ...
    public int getRotationOverride() {
        return prefs.getInt("rotation_override", 0);
    }

    public void setRotationOverride(int rotation) {
        prefs.edit().putInt("rotation_override", rotation).apply();
    }

    public boolean getPreviewEnabled() {
        return prefs.getBoolean("preview_enabled", true);
    }

    public void setPreviewEnabled(boolean enabled) {
        prefs.edit().putBoolean("preview_enabled", enabled).apply();
    }
